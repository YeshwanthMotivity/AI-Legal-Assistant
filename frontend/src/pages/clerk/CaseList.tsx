  ...
  return (
    <PortalLayout title={t('clerk.pages.casesTitle')} subtitle={t('clerk.pages.casesSubtitle')}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard label="Finalized" value={stats.finalized} icon={CheckCircle2} className="border-l-4 border-l-emerald-500" />
      </div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="relative w-full sm:w-96">
            ...
            <input 
              className="w-full bg-card border rounded-lg pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all font-medium"
      ...
      {/* Create Case Modal */}
      <dialog id="create-case-modal" className="modal bg-transparent backdrop:bg-black/50 p-0 rounded-2xl border shadow-2xl w-full max-w-2xl overflow-hidden">
      ...
      <dialog id="edit-metadata-modal" className="modal bg-transparent backdrop:bg-black/50 p-0 rounded-2xl border shadow-2xl w-full max-w-md overflow-hidden">
         <div className="bg-card">
