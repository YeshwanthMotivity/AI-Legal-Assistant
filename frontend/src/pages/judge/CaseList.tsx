                ...
                return (
                  <div key={c.id} className="bg-[var(--bg-card)] p-5 rounded-lg editorial-shadow border border-outline-variant/30 hover:bg-surface-container-low dark:hover:bg-surface-container-high transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-outline-variant/30">
                      ...
                      <button
                        className="text-[10px] font-bold uppercase tracking-widest text-error hover:bg-error/10 py-2 px-4 rounded transition-all flex items-center gap-2 border border-transparent hover:border-error/20"
