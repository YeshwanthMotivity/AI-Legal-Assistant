...
const IntelligenceCenter = ({
 ...
 <div className="w-24 h-24 rounded-[2.5rem] bg-emerald-600/5 flex items-center justify-center text-[var(--primary)]/30">
 ...
 className="group bg-[var(--bg-card)] p-8 rounded-[2.5rem] border border-border/80 hover:border-emerald-600/30 hover:shadow-2xl hover:shadow-emerald-500/5 transition-all duration-500 block relative overflow-hidden"
 >
 ...
 <div className="shrink-0 flex flex-col items-end gap-3 bg-[var(--bg-surface)] p-4 rounded-3xl border border-border group-hover:bg-emerald-600 group-hover:border-emerald-500 transition-all">
 ...
 <div className={cn("h-full transition-all duration-1000", pct >= 70 ?"bg-emerald-500":"bg-emerald-600 group-hover:bg-[var(--bg-card)]")} style={{ width: `${pct}%` }} />
 </div>
 </div>
 </div>
 ...
 <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground group-hover:text-[var(--primary)] transition-colors">Digital Case File Accessible</span>
 </div>
 ...
 <div className="shrink-0 w-12 h-12 rounded-[1.25rem] bg-[var(--bg-card)] border border-border shadow-sm flex items-center justify-center text-[var(--primary)] group-hover:bg-emerald-600 group-hover:text-white transition-all">
