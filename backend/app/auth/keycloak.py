...
async def create_keycloak_user(email: str, username: str, password: str, role: str, first_name: str = "", last_name: str = "") -> str:
    ...
    async with httpx.AsyncClient() as client:
        ...
        if r.status_code == 409:
            raise Exception("User already exists in Keycloak")
        r.raise_for_status()
