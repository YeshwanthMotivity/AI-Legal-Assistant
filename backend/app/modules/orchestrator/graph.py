...
graph.add_node("graph_independent_node", graph_independent_node)
...
graph.add_edge("document_agent_node", "graph_independent_node")

# Dependencies (Level 2)
graph.add_edge("search_agent_node", "graph_dependent_node")

# Convergence (Level 3)
graph.add_edge("graph_independent_node", "context_builder_node")
