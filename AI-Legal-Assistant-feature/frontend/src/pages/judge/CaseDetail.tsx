...
const CaseWorkflow = ({ viewedIdx, currentIdx, stages, onStageClick }: { viewedIdx: number, currentIdx: number, stages: any[], onStageClick: (idx: number) => void }) => {
  return (
    <div className="w-full px-12 py-10 bg-white border-b border-border shadow-[0_4px_30px_rgba(0,0,0,0.01)] relative z-10">
          ...
          return (
            <div key={stage.id} className="relative z-10 flex flex-col group flex-1 items-center">
              ...
              >
                <div 
                  className={cn(
                    "w-10 h-10 rounded-full flex items-center justify-center transition-all duration-500 border-2 bg-white relative z-10",
                    isViewed ? "border-emerald-600 text-emerald-600 shadow-[0_0_20px_rgba(5,150,105,0.2)] scale-110" : 
                    isCompleted ? "border-emerald-500 text-emerald-600 shadow-sm" : 
                ...
                <div className="text-center px-2">
                   <p className={cn(
                     ...
                     isViewed ? "text-emerald-600" : isReached ? "text-emerald-700/60" : "text-muted-foreground/30"
                   )}>
                     Phase {stage.id}
                   </p>
                   <p className={cn(
...
const FeedbackForm = ({ caseId, onSubmit }: { caseId: string, onSubmit: (data: any) => Promise<void> }) => {
  ...
  return (
    <div className="w-full bg-white p-10 rounded-[2rem] border border-border shadow-sm animate-in fade-in slide-in-from-bottom-8 duration-700">
      <header className="flex items-center gap-5 border-b border-border/50 pb-6 mb-8">
        ...
        <div>
           ...
           <p className="text-[10px] font-black text-emerald-600/70 uppercase tracking-[0.2em] mt-1.5">System Calibration Protocol</p>
        </div>
      </header>
      ...
      <div className="grid grid-cols-12 gap-10">
            ...
            {['legal_relevance_score', 'reasoning_quality_score', 'explanation_clarity_score'].map((field) => (
              <div key={field} className="space-y-3">
                <div className="flex justify-between items-center">
                   ...
                   <span className="text-[10px] font-black tracking-[0.1em] px-2 py-1 bg-[#F8FAFC] border border-border/80 rounded-md text-emerald-600">
         ...
         <div className="col-span-12 lg:col-span-7 flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col gap-6">
              <textarea 
                className="w-full flex-1 min-h-[160px] p-5 bg-[#F8FAFC] border border-border/80 rounded-xl text-sm font-medium focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 outline-none transition-all placeholder:italic placeholder:opacity-50"
...
const CaseDetail = () => {
    ...
    return (
      <PortalLayout title="Case Orchestrator" hideHeaderContent>
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6">
           ...
           <p className="text-xs font-black uppercase tracking-[.3em] text-emerald-600/60">Initializing Judicial Node...</p>
        </div>
      </PortalLayout>
    )
  }
  ...
  return (
    <PortalLayout title="Case Orchestrator" hideHeaderContent>
      <div className="flex h-[calc(100vh-40px)] -m-10 overflow-hidden bg-[#F8FAFC]">
            ...
            <div className="px-10 py-10">
              ...
              {viewedIdx === 0 && (
                <div className="max-w-6xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
                  <header className="flex items-center gap-6 pb-2">
                     <div className="w-16 h-16 bg-white border border-border shadow-2xl rounded-[1.75rem] flex items-center justify-center text-emerald-600">
                  ...
                  <div className="grid grid-cols-12 gap-10">
                     <div className="col-span-8 bg-white p-12 rounded-[3.5rem] shadow-[0_4px_30px_rgba(0,0,0,0.02)] border border-border/80 space-y-12">
                        ...
                        <section className="space-y-6">
                           ...
                           <div className="p-10 bg-[#F8FAFC] rounded-[2.5rem] border border-emerald-100/40 relative overflow-hidden group">
                        ...
                        <section className="grid grid-cols-3 gap-8 pt-4">
                           {[
                             ...
                             <div key={i} className="p-6 bg-muted/10 rounded-3xl border border-border/20 flex flex-col gap-3 group hover:border-emerald-600/20 transition-all duration-300">
                                <item.icon className="w-4 h-4 text-emerald-600/40 group-hover:text-emerald-600 transition-colors" />
                                <div>
                     ...
                     <div className="col-span-4 space-y-8">
                        <div className="bg-white p-12 rounded-[3.5rem] shadow-[0_4px_30px_rgba(0,0,0,0.02)] border border-border/80 relative overflow-hidden group">
                           ...
                           <h3 className="text-[10px] font-black uppercase tracking-[.25em] text-emerald-600 mb-10 flex items-center gap-3">
                        ...
                        <div className="bg-white p-10 rounded-[3rem] border border-border/80 shadow-[0_4px_30px_rgba(0,0,0,0.02)] hover:border-emerald-500/30 transition-all duration-300">
                           ...
                           <div className="mt-6 flex items-center gap-3 text-emerald-600 py-2 px-4 bg-emerald-50 w-fit rounded-full border border-emerald-100">
              ...
              {viewedIdx === 1 && (
                <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
                   ...
                   <div className="bg-white p-12 rounded-[4rem] shadow-sm border border-border/80">
                      <DocumentsPanel
                ...
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                   <IntelligenceCenter
                    ...
                    {!isReady && !isActivelyLoading && (
                      <div className="mt-12 text-center p-24 bg-white border-2 border-dashed border-border/80 rounded-[4rem] shadow-inner max-w-4xl mx-auto group hover:border-emerald-600/30 transition-all">
                          <div className="w-24 h-24 bg-emerald-50 border border-emerald-100 rounded-[2.5rem] flex items-center justify-center mx-auto mb-10 group-hover:scale-110 transition-transform">
                             <BrainCircuit className="w-12 h-12 text-emerald-600 animate-pulse" />
                          </div>
              ...
              {viewedIdx === 3 && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-10">
                    ...
                    <div className="bg-white p-12 rounded-[4rem] shadow-sm border border-border/80 overflow-hidden">
                      <JudgmentEditor
                   ...
                   <button
                      className={cn(
                        ...
                        isAiPanelOpen
                          ...
                          : "bg-white border-border text-muted-foreground hover:border-emerald-600/30 hover:text-emerald-700"
                      )}
        ...
        <aside
          className={cn(
            "h-full border-l border-border bg-white transition-all duration-500 overflow-hidden flex flex-col",
            isAiPanelOpen ? "w-[400px] opacity-100" : "w-0 opacity-0"
          )}
        >
          {/* Assistant Header */}
          <div className="p-6 border-b border-border flex justify-between items-center bg-[#F8FAFC] shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[9px] font-black text-emerald-600 uppercase tracking-widest mt-1.5">Precision Node Active</p>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-3">
                {assistant.actions.map((action, i) => (
                  ...
                  >
                    ...
                    <div className="p-1.5 bg-white group-hover:bg-emerald-100 rounded-lg border border-border/40 transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                   <div className="w-8 h-8 rounded-xl bg-white flex items-center justify-center shrink-0 border border-border"><User className="w-4 h-4 text-muted-foreground" /></div>
          ...
          {/* Input footer */}
          <div className="p-5 border-t border-border bg-[#F8FAFC] shrink-0">
            <div className="relative">
              <input
                type="text"
                placeholder="Ask Cylix..."
                className="w-full bg-white border border-border/60 hover:border-emerald-600/30 focus:border-emerald-600/50 focus:ring-4 focus:ring-emerald-600/5 h-12 pl-5 pr-14 rounded-2xl outline-none transition-all placeholder:opacity-40 text-sm font-bold"
              />
