                        ...
                        <TableCell>
                          <Badge 
                            ...
                            className={cn(
                              ...
                              String(user.is_active).toLowerCase() === 'true' ? "border-emerald-500/20 text-emerald-600 bg-emerald-500/5" : "border-destructive/20 text-destructive bg-destructive/5"
                            )}
                          >
